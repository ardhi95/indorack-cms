...
<div class="tab-pane" id="tab1" >
				...
				<?php echo $this->Form->input("customer_id",
					...
					<div id="newCustomerDiv" style="display:none; background-color:#eaeaea;">
						...
						<?php echo $this->Form->input("firstname",
							array(
								"div"			=>	array("class"=>"form-group"),
								"label"			=>	array("class"	=>	"col-md-3","text"=>__("First Name (*)")),
						...
						<?php echo $this->Form->input("lastname",
							array(
								"div"			=>	array("class"=>"form-group"),
								"label"			=>	array("class"	=>	"col-md-3","text"=>__("Last Name")),
								"between"		=>	'<div class="col-md-9">',
								"after"			=>	"</div>",
								"autocomplete"	=>	"off",
								"type"			=>	"text",
						...
						<?php echo $this->Form->input("email",
							array(
								"div"			=>	array("class"=>"form-group"),
								"label"			=>	array("class"	=>	"col-md-3","text"=>__("Email (*)")),
								"between"		=>	'<div class="col-md-9">',
								"after"			=>	"</div>",
						...
						<?php echo $this->Form->input("password",
							array(
								"div"			=>	array("class"=>"form-group"),
								"label"			=>	array("class"	=>	"col-md-3","text"=>__("Password (*)")),
								"between"		=>	'<div class="col-md-9">',
								"after"			=>	"</div>",
								"autocomplete"	=>	"new-password",
								"type"			=>	"password",
						...
						<div id="assemblyDiv">
							<?php echo $this->Form->input("assembly_date",
								array(
									...
									"between"		=>	'<div class="col-md-12">',
									"after"			=>	'</div><label class="check"><input type="checkbox" class="icheckbox" id="sameDayChecked"/>Same day</label>',
									"autocomplete"	=>	"off",
									"type"			=>	"text",
									"class"			=>	'form-control datetimepicker',
									'error' 		=>	array(
	...
	<div class="panel-footer">
		...
		<?php if ($detail["DeliveryStatus"]["id"] != "6"): ?>
        ...
        <div class="col-xs-12">
            ...
            <?php echo $this->Form->input("qty",
                ...
                <div class="panel-footer">
                    ...
                    <button type="submit" class="btn btn-primary pull-right" style="margin-left:10px;" onclick="$('#SaveFlag').val('0');AddNewProductForm();" <?php echo $disabled2?>><?php echo __('Save and add more')?><span class="fa fa-floppy-o fa-right"></span></button>
