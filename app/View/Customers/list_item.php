...
function ChangeStatus(el,msg,id,status)
{
	if(status == "0")
	{
		msg		=	"<?php echo __('Deactivate customer will make this customer no longer can login to mobile apps any more. Do you really want to continue ?')?>";
	}
											...
											buttons: [
													{
														addClass: 'btn btn-success btn-clean', text: 'Yes', onClick: function($noty) {
															$noty.close();
															location.href='<?php echo $settings['cms_url']?>Customers/Edit/'+id+'/1/50';
													}
													},
													{
            ...
            <table class="table table-bordered table-striped table-actions">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <?php
						$disabledCheck	=	"";
                        if($data["User"]["id"] == "45" or $data["User"]["aro_id"] == "1")
						{
                        ...
                        <td>
                            ...
                            <a rel="lightbox" title="<?php echo $data[$ModelName]['fullname'] ?>" href="<?php echo $data["MaxWidth"]["host"].$data["MaxWidth"]["url"]?>?time=<?php echo time()?>" style="border:0px;">
                        ...
                        <td><?php echo $this->General->IsEmptyVal($data[$ModelName]['phone1'])?></td>
