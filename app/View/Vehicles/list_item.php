            ...
            <table class="table table-bordered table-striped table-actions">
                <thead>
                    <tr>
                        ...
                        <th style="width:12%">
                        	<?php echo $this->Paginator->sort("$ModelName.vehicle_no",__('Vehicle No'),array("class"=>"sorting"));?>
                        </th>
                        
                        <th style="width:17%">
                        	<?php echo $this->Paginator->sort("User.firstname",__('Driver'),array("class"=>"sorting"));?>
                        </th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        	<?php echo $this->General->IsEmptyVal($data[$ModelName]['vehicle_no'])?>
                        </td>
                         <td>
