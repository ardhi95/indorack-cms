    	...
    	<div class="col-md-12">
            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                	<div class="col-md-12">
                    	<?php echo $this->Form->input("vehicle_no",
                            array(
                                "div"			=>	array("class"=>"form-group"),
                                "label"			=>	array("class"	=>	"col-md-3 control-label","text"=>__("Vehicle No (*)")),
                        ...
                        <?php echo $this->Form->input("user_id",
                            array(
                                "div"			=>	array("class"=>"form-group"),
                                "label"			=>	array("class"	=>	"col-md-3 control-label","text"=>__("Driver (*)")),
                                "between"		=>	'<div class="col-md-5">',
                                "after"			=>	"</div>",
                                "autocomplete"	=>	"off",
                ...
                <div class="panel-footer">
                    ...
                    <button type="submit" onclick="OnClickSaveStay()" class="btn btn-primary pull-right" style="margin-left:10px;"><?php echo __('Save and add more')?><span class="fa fa-floppy-o fa-right"></span></button>
                </div>
            </div>
            </form>
        </div>
