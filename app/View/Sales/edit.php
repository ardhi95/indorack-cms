            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                	<div class="col-md-12">
                      ...
                      <?php
                        $imgPreview	=	(!empty($detail["ProductImage"]["Thumbnail"]["id"])) ? $detail["ProductImage"]["Thumbnail"]["host"].$detail["ProductImage"]["Thumbnail"]["url"]."?time=".time() : $this->webroot ."img/default_content.png";

						 $imgPreviewBig	=	(!empty($detail["ProductImage"]["MaxWidth"]["id"])) ? $detail["ProductImage"]["MaxWidth"]["host"].$detail["ProductImage"]["MaxWidth"]["url"]."?time=".time() : $this->webroot ."img/default_content.png";
						...
						echo $this->Form->input("pdf",
                            array(
                                "div"			=>	array("class"=>"form-group"),
                                "label"			=>	array("class"	=>	"col-md-3 control-label","text"=>__("PDF")),
                                "between"		=>	'<div class="col-md-7">
								',
                                "after"			=>	'</div>',
                                "autocomplete"	=>	"off",
