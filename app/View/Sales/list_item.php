            ...
            <table class="table table-bordered table-striped table-actions">
                <thead>
                    <tr>
                        ...
                        <th style="width:11%" class="text-center"><?php echo __('Actions')?></th>
                    </tr>
                </thead>
                <tbody>
                	<?php $count = 0;?>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                        	<?php echo date("M d, Y",strtotime($data[$ModelName]['modified'])) ?>
                        </td>
                        <td class="text-center">

                            <?php if($data[$ModelName]['status']=="1"):?>
                            	<a href="<?= $settings['cms_url']; ?>Orders/Edit/<?= $data[$ModelName]['order_id']; ?>/1/50" class="btn btn-success btn-condensed btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo __('See Detail')?>">See Detail</a>
                            <?php else: ?>
                            	<!-- <a href="javascript:void(0);" class="btn btn-danger btn-condensed btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo __('Change to Seen')?>" onclick="ChangeStatus(this,'<?php echo __('Do you realy want update this item ?')?>','<?php echo $data[$ModelName]['id']?>','1')">
								<i class="fa fa-plus"></i> Create
                            	</a> -->
                            	<a href="<?= $settings['cms_url'] ?>/Orders/Add/<?= $data[$ModelName]['id']; ?>" class="btn btn-danger btn-condensed btn-sm" data-toggle="tooltip" data-placement="top" title="<?php echo __('Create Order')?>">
								<i class="fa fa-plus"></i> Create
                            	</a>
                            <?php endif;?>
