            ...
            <table class="table table-bordered table-striped table-actions">
                <thead>
                    <tr>
                        ...
                        <th>
                        	<?php echo $this->Paginator->sort("DeliveryType.name",__('Delivery Type'),array("class"=>"sorting"));?>
                        </th>
                        <th>
                        ...
                        <th>
                        	<?php echo $this->Paginator->sort("DeliveryStatus.name",__('Delivery Status'),array("class"=>"sorting","title"=>"Delivery Status"));?>
                        </th>
                        
                        <th class="text-center">
                        	<?php echo $this->Paginator->sort("AssemblyStatus.name",__('Assembling Status'),array("class"=>"sorting","title"=>"Assembling Status"));?>
                        </th>
                        
                        <th class="text-center">
                        	<?php echo $this->Paginator->sort("PickupStatus.name",__('Pickup  Status'),array("class"=>"sorting","title"=>"Pickup  Status"));?>
                        </th>
