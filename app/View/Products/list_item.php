            ...
            <table class="table table-bordered table-striped table-actions">
                <thead>
                    <tr>
                        ...
                        <th style="width:7%">
                        	<?php echo $this->Paginator->sort("$ModelName.code",__('Code'),array("class"=>"sorting"));?>
                        </th>
                        <th style="width:12%">
                ...
                <tbody>
                    ...
                    <tr>
                    	...
                    	<td><?php echo $no ?></td>
                        <td>
                        	<?php if(!empty($data["ProductImage"]["Thumbnail"]["id"])):?>
                            <a rel="lightbox" title="<?php echo $data[$ModelName]['name'] ?>" href="<?php echo $data["ProductImage"]["MaxWidth"]["host"].$data["ProductImage"]["MaxWidth"]["url"]?>?time=<?php echo time()?>" style="border:0px;">
								<img src="<?php echo $data["ProductImage"]["Thumbnail"]["host"].$data["ProductImage"]["Thumbnail"]["url"]?>?time=<?php echo time()?>" width="60" height="60"/>
							</a>
                            <?php else:?>
                        ...
                        <td>
							<?php echo $data[$ModelName]['code']?>
                        </td>
                        <td>
                        	<?php echo $this->General->IsEmptyVal($data[$ModelName]['name'])?>
                        </td>
