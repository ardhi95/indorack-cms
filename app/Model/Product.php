	...
	function ValidateData()
	{
		...
		$this->validate 	= array(
			'code' => array(
				'notBlank'	=> array(
					'rule' 		=> "notBlank",
					'message' 	=> __d('validation',"Please insert product code/id")
				),
				'minLength'	=> array(
					'rule' 		=> array("minLength",2),
					'message' 	=> __d('validation',"Product code is too short")
				),
				'maxLength'	=> array(
					'rule' 		=> array("maxLength",100),
					'message' 	=> __d('validation',"Product code is too long")
				),
				'isUnique'	=> array(
					'rule' 		=> "isUnique",
					'message' 	=> __d('validation',"Product code already exists"),
					"on"		=>	"create"
				),
				'UniqueCodeEdit'	=> array(
					'rule' 		=> "UniqueCodeEdit",
					'message' 	=> __d('validation',"Product code already exists"),
					"on"		=>	"update"
				)
