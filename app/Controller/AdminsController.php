...
class AdminsController extends AppController
{
	...
	function ListItem($excel = "false")
	{
		...
		{
			$filter_paginate	=	array(
										"{$this->ModelName}.is_admin"	=>	array("1")
									);
		}
		else if($this->profile["MyAro"]["id"] == $premiumAdminAro["MyAro"]["id"])
		{
			$filter_paginate	=	array(
										...
										"OR"	=>	array(
											...
											"NOT"	=>	array(
												"{$this->ModelName}.aro_id"	=> $superAdminAro["MyAro"]["id"]
	...
	function Add()
	{
		...
		if(!empty($this->request->data))
		{
			...
			$this->request->data[$this->ModelName]['current_latitude']  	=	"-6.1376514";
			$this->request->data[$this->ModelName]['current_longitude']  	=	"106.8280615";
